...
class article extends database
{
    ...
    {
        $query = 'SELECT Articles.id, pseudo, msg, DATE_FORMAT(dateArticles, "%d/%m/%Y %H:%i") as dateArticles, utilisateurs.id as id_auteur FROM Articles LEFT JOIN utilisateurs ON Articles.id_utilisateurs = utilisateurs.id ORDER BY dateArticles DESC LIMIT 4 OFFSET :offset ;';
