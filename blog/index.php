      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         <!--<a class="nav-link" href="index.php?connexionAdmin">connecté</a>-->
          <a class="nav-link" href="index.php?deconnexion" name="deco">deconnexion</a>
        </li>
...
else if (isset($_GET['submitDelet'])){
  include 'controler/deletArticle.php';
