...
<?= $searchuser->msg ?><br><br><?= $searchuser->dateArticles ?>
  <div class ="divprofil">
    ...
    <a href="index.php?postCom&Articleid=<?= $searchuser->id ?>"><button class="btnComprofile" name="btnCom" type="submit" value = "">commentaire</button></a>
  </div>    
</div>
...
<?= $profile->msg ?><br><br><?= $profile->dateArticles ?>
  <div class ="divprofil">
    ...
    <a href="index.php?postCom&Articleid=<?= $profile->id ?>"><button class="btnComprofile" name="btnCom" type="submit" value = "">commentaire</button></a>
  </div>    
</div>
<?php 
