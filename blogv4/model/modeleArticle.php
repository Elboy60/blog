...
class article extends database
{
    ...
    public function searchAllArticle(){
        $rechercheArticle = 'SELECT Articles.`id`, `msg`, `dateArticles`, `pseudo`, nom FROM `Articles` INNER JOIN utilisateurs ON Articles.id_utilisateurs = utilisateurs.id INNER JOIN Roles ON Roles.id = utilisateurs.id_Roles WHERE msg LIKE ? ';
        $article = $this->db->prepare($rechercheArticle);
