...
if(isset($_GET['page']) && $curentPage > $nbrPagess){ 
...
if(isset($fff) && !empty($fff)){
  ...
  <tr>
      ...
      <span class="bold"><a class="lienUser" href="index.php?profil&profile=<?= $searchuser->id_auteur ?>"><?php echo $searchuser->pseudo;} ?></a></span><br><br>
            ...
            ?>
                  <a href="index.php?postCom&Articleid=<?= $searchuser->id ?>&etat=<?= $searchuser->etatArticle ?>"><button class="btnCom" name="btnCom" type="submit" value = "">commentaire</button></a>
        ...
        ?>
          <div class="testhome reveal">
            ...
            <img src="assets/avatars/<?= $article->avatars ?>" alt="" class="imageProfilArticle">
              <span class="bold"><a class="lienUser" href="index.php?profil&profile=<?= $article->id_auteur ?>"><?php echo $article->pseudo;} ?></a></span><br><br>
            ...
            ?>
                  <a href="index.php?postCom&Articleid=<?= $article->id ?>&etat=<?=$article->etatArticle?> ">
                  <button class="btnCom" name="btnCom" type="submit" value = "">commentaire</button>
                </a>
                  <?php
                    if($article->nbrcom == 1){
                  ?>
