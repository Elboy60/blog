...
<div class="divArticle"> 
 ...
 <?php if (isset($_SESSION['id'])) {
        if (($_SESSION['id'] === $classArticle->id_utilisateurs) || $_SESSION['role'] === 'admin') { ?>
    <form method="post">
    <button class = btnclotureArtice name="btnCloture">cloturé l'article</button>
    </form>
         <?php }
            } ?>
...
<?php if(is_null($com->pseudo))
           ...
           <img src="assets/avatars/<?= $com->avatars ?>" alt="" class="imageProfilArticle">
           <span class="bold"><a class="lienUser" href="index.php?profil&profile=<?= $com->id_auteur ?>"><?= $com->pseudo ;} ?></a></span><br><br> 
          <?= $com->commentaire ?><br> 
